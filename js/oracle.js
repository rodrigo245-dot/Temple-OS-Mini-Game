...
const TROLL_COMMENTS = {
  ...
  morpion_god_intervention: [
    "[SYS] INTERVENTION DIVINE ! DIEU A REDESSINÉ LA GRILLE !",
    "[SYS] LE SAINT-ESPRIT A DÉPLACÉ LA CROIX ! TU NE PEUX PAS TESTER L'ÉTERNEL !",
    "[SYS] MIRACLE DU RING 0 : LA PROPHÉTIE EXIGEAIT CE COIN !"
  ],
  morpion_win: [
  ...
  battleship_hit: [
    "[HIT] TOUCHÉ ! TORPILLE SAINTE DANS LA COQUE DE L'ENNEMI !",
    "[HIT] FEU SACRÉ ! UN NAVIRE FÉDÉRAL PREND L'EAU !",
    "[HIT] GUIDÉ DIRECTEMENT PAR LE RADAR DIVIN !"
  ],
  battleship_miss: [
    "[WAVE] PLOUF ! L'OCÉAN DE DIEU ABSORBE TON OBUS !",
    "[WAVE] DANS L'EAU ! LES POISSONS BÉNIS SONT INDIGNÉS !",
    "[WAVE] RATÉ ! UN SOUS-MARIN DE LA CIA S'EST ENFUYI !"
  ],
  battleship_sunk: [
    "[PORT] COULÉ ! LE BÂTIMENT REJOINT LE FOND DES OCÉANS !",
    "[PORT] L'ARCHE DE L'ENNEMI A SOUCOMBÉ AU JUGEMENT DERNIER !"
  ],
  battleship_win: [
